...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/raptor2.pc.in \
	...
	build/install-sh build/ltmain.sh build/missing mkinstalldirs
...
AR = ar
AUTOCONF = autoconf
AUTOHEADER = ${SHELL} /mnt/d/PROGRA/MDB/raptor2-2.0.15/build/missing autoheader
AUTOMAKE = automake
AWK = gawk
BISON = bison
CC = gcc
...
CFLAGS = 
CPP = gcc -E
CPPFLAGS =  -Wall -Wc++-compat -Wextra -Wunused -Waggregate-return -Wbad-function-cast -Wcast-align -Wdeclaration-after-statement -Wdisabled-optimization -Wdiv-by-zero -Wendif-labels -Werror-implicit-function-declaration -Wfloat-equal -Wformat-security -Wframe-larger-than=4096 -Winit-self -Winline -Wmissing-declarations -Wmissing-format-attribute -Wmissing-noreturn -Wmissing-prototypes -Wnested-externs -Wold-style-definition -Wpacked -Wpointer-arith -Wredundant-decls -Wshadow -Wsign-compare -Wstrict-prototypes -Wswitch-enum -Wundef -Wunreachable-code -Wunsafe-loop-optimizations -Wwrite-strings -Wno-conversion -Wno-format-nonliteral -Wno-missing-field-initializers -Wno-sign-conversion -Wno-system-headers -Wno-unused-parameter -Wswitch-bool -Wlogical-not-parentheses -Wsizeof-array-argument -Wbool-compare -Wc90-c99-compat -Wc99-c11-compat -DRAPTOR_INTERNAL=1 -I/usr/include/libxml2 
CURL_CONFIG = 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
...
LIBCURL_CFLAGS = 
LIBCURL_LIBS = 
LIBOBJS =  ${LIBOBJDIR}raptor_www_libxml$U.o
LIBS = 
...
LIPO = 
LN_S = ln -s
LTLIBOBJS =  ${LIBOBJDIR}raptor_www_libxml$U.lo
LT_SYS_LIBRARY_PATH = 
MAINT = 
MAKEINFO = ${SHELL} /mnt/d/PROGRA/MDB/raptor2-2.0.15/build/missing makeinfo
MANIFEST_TOOL = :
MEM = 
MEM_LIBS = 
...
PKG_CONFIG_REQUIRES = 
RANLIB = ranlib
RAPTOR_LDFLAGS =  -lxml2
RAPTOR_LIBTOOLLIBS = libraptor2.la
RAPTOR_LIBTOOL_VERSION = 0:0:0
RAPTOR_PARSERS =  rdfxml ntriples turtle trig guess rss-tag-soup rdfa nquads
...
XSLT_CONFIG = 
abs_builddir = /mnt/d/PROGRA/MDB/raptor2-2.0.15
abs_srcdir = /mnt/d/PROGRA/MDB/raptor2-2.0.15
abs_top_builddir = /mnt/d/PROGRA/MDB/raptor2-2.0.15
abs_top_srcdir = /mnt/d/PROGRA/MDB/raptor2-2.0.15
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /mnt/d/PROGRA/MDB/raptor2-2.0.15/build/install-sh
...
EXTRA_DIST = CMakeLists.txt ChangeLog.1 ChangeLog.2 ChangeLog.3 \
	ChangeLog.4 ChangeLog.5 ChangeLog.6 ChangeLog.7 ChangeLog.8 \
	ChangeLog.9 ChangeLog.10 ChangeLog.11 ChangeLog.12 \
	ChangeLog.13 ChangeLog.14 README LICENSE.txt README.html \
	NEWS.html LICENSE.html INSTALL.html README-cmake.md \
	RELEASE.html LICENSE-2.0.txt NOTICE UPGRADING.html \
	raptor2.rdf.in autogen.sh raptor2.spec.in raptor2.pc.in \
	$(am__append_1)
